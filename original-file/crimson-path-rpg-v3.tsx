...
Votre aventure commence ici.`;
  ...
  const startEpisode3 = () => {
    setEpisode(3);
    const storyText = `[ÉPISODE 3 - À VENIR]

Votre aventure continue... Les épisodes suivants seront ajoutés prochainement avec :

- La confrontation avec Inquisiteur Corvus
- Le rassemblement des Marqués
- L'Alignement des Trois Lunes
- Les choix finaux qui détermineront votre destinée
